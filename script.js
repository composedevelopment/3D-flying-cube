...
const watergeometry = new THREE.BoxGeometry(18, 12, 16);
...
function animate() {
    ...
    objs.forEach(child => {
        child.position.y = -16 + (Math.sin(sin) * child.randomSpeed)
